#Hellow Everyone
I Am Kaami Khan Bhutta

#!/usr/bin/python
# -*- coding: utf-8

#AUTHOR : KAAMI KHAN (MR. KAAMI)
#OPEN SOURCE :)
...
def main():
	...
	print("\033[93;1m  [2] RANDOM CLONING")
	print("\033[94;1m  [3] UPDATE TOOL")
	print("\033[96;1m  [4] PUBLIC ID CLONING")
	print("\033[90;1m  [5] EXIT")
	print("")

try:
			os.system("git clone https://github.com/KAAMI-KHAN/MHKB")
			os.system("rm -rf MHKB.py")
			os.system("cp -f MHKB/MHKB.py \\.")
			os.system("rm -rf MHKB")
...
print(" \033[1;32m[KAAMI-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									print(" \033[1;33m[KAAMI-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
